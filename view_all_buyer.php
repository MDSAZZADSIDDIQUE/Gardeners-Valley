        ...
        <tr>
            ...
            <td class="dashboard">
                <table class="dashboard_table">
                    ...
                    <?php
                    $buyerInformationFile = fopen('buyer_information.txt', 'r');
                    for ($i = 1; !feof($buyerInformationFile); $i++)
                    {
                        echo "<tr>";
                        $buyersInformation = fgets($buyerInformationFile);
                        $buyerInformation = explode('|', $buyersInformation);
                        for ($j = 0; $j < count($buyerInformation); $j++)
                        {
                            if ($j == 6) {
                                continue;
                            }
                            echo "<td class='dashboard_table_data'>{$buyerInformation[$j]}</td>";
                        }
                        ?>
