        ...
        <tr>
            ...
            <td class="dashboard">
                <table class="dashboard_table">
                    ...
                    <?php
                    $expertInformationFile = fopen('expert_information.txt', 'r');
                    for ($i = 1; !feof($expertInformationFile); $i++)
                    {
                        echo "<tr>";
                        $expertsInformation = fgets($expertInformationFile);
                        $expertInformation = explode('|', $expertsInformation);
                        for ($j = 0; $j < count($expertInformation); $j++)
                        {
                            if ($j == 6) {
                                continue;
                            }
                            echo "<td class='dashboard_table_data'>{$expertInformation[$j]}</td>";
                        }
                        ?>
