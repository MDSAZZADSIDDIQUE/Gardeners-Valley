        ...
        <tr>
            ...
            <td class="dashboard">
                <table class="dashboard_table">
                    ...
                    <?php
                    $adminInformationFile = fopen('admin_information.txt', 'r');
                    for ($i = 1; !feof($adminInformationFile); $i++)
                    {
                        echo "<tr>";
                        $adminsInformation = fgets($adminInformationFile);
                        $adminInformation = explode('|', $adminsInformation);
                        for ($j = 0; $j < count($adminInformation); $j++)
                        {
                            if ($j == 6) {
                                continue;
                            }
                            echo "<td class='dashboard_table_data'>{$adminInformation[$j]}</td>";
                        }
                        ?>
